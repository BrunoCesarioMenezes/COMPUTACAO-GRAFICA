...
export function updateDoors(doors, cameraPosition, deltaTime) {
  for (const door of doors) {
    ...
    const smooth = 1 - Math.exp(-3.2 * deltaTime);
    door.progress = THREE.MathUtils.lerp(door.progress, door.target, smooth);
