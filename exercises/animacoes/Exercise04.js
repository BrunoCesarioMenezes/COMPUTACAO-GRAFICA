...
var cylinderMaterial3 = new THREE.MeshLambertMaterial( {color:'rgb(255, 239, 100)'} );
var cylinder3 = new THREE.Mesh( cylinderGeometry3, cylinderMaterial3 );
var cylinder4 = cylinder3.clone();
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder3.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90))); // R1
    cylinder3.matrix.multiply(mat4.makeRotationX(angle3)); // R1
    cylinder3.matrix.multiply(mat4.makeTranslation(0.5, 0.0, 0.0)); // T1

    cylinder4.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90))); // R1
    cylinder4.matrix.multiply(mat4.makeRotationX(-angle4)); // R1
    cylinder4.matrix.multiply(mat4.makeTranslation(-0.5, 0.0, 0.0)); // T1
  }
}
